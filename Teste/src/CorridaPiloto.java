...
public class CorridaPiloto extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pioto :");

        jLabel3.setText("Tempo :");

        jLabel4.setText("Posição :");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Daniel Ricciardo", "Lando Norris", "Sebastian Vettel", "Kimi Raikkonen" }));
